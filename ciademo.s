...
bool System_Init()
{
 ...
 194:	|  |  |  |            move.w dff010 <gcc8_c_support.c.ba290747+0xdf865a>,d4
 19a:	|  |  |  |            move.w d4,2730 <_ZL12sSavedADKCON>
	sSavedDMACON = custom.dmaconr;
 1a0:	|  |  |  |            move.w dff002 <gcc8_c_support.c.ba290747+0xdf864c>,d3
 1a6:	|  |  |  |            move.w d3,272e <_ZL12sSavedDMACON>
	sSavedINTENA = custom.intenar;
 1ac:	|  |  |  |            move.w dff01c <gcc8_c_support.c.ba290747+0xdf8666>,d2
 1b2:	|  |  |  |            move.w d2,272c <_ZL12sSavedINTENA>

	// Disable all interrupts.
	custom.intena = (u16) ~INTF_SETCLR;
 1b8:	|  |  |  |            move.w #32767,dff09a <gcc8_c_support.c.ba290747+0xdf86e4>

	// Clear all pending interrupts.
	custom.intreq = (u16) ~INTF_SETCLR;
 1c0:	|  |  |  |            move.w #32767,dff09c <gcc8_c_support.c.ba290747+0xdf86e6>

	// Clear all DMA channels.
	custom.dmacon = (u16) ~DMAF_SETCLR;
 1c8:	|  |  |  |            move.w #32767,dff096 <gcc8_c_support.c.ba290747+0xdf86e0>

	// Disable all CIA interrupts.
	ciaa.ciaicr = (u8) ~CIAICRF_SETCLR;
 1d0:	|  |  |  |            move.b #127,bfed01 <gcc8_c_support.c.ba290747+0xbf834b>
	ciab.ciaicr = (u8) ~CIAICRF_SETCLR;
 1d8:	|  |  |  |            move.b #127,bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>

	// Save current CIA interrupts, which clears any pending.
	sSavedCIAAICR = ciaa.ciaicr;
 1e0:	|  |  |  |            move.b bfed01 <gcc8_c_support.c.ba290747+0xbf834b>,d6
 1e6:	|  |  |  |            move.b d6,2727 <_ZL13sSavedCIAAICR>
	sSavedCIABICR = ciab.ciaicr;
 1ec:	|  |  |  |            move.b bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>,d5
 1f2:	|  |  |  |            move.b d5,2726 <_ZL13sSavedCIABICR>

	// Save current CIA controls.
	sSavedCIAACRA = ciaa.ciacra;
 1f8:	|  |  |  |            move.b bfee01 <gcc8_c_support.c.ba290747+0xbf844b>,51(sp)
 200:	|  |  |  |            move.b 51(sp),272b <_ZL13sSavedCIAACRA>
	sSavedCIAACRB = ciaa.ciacrb;
 208:	|  |  |  |            move.b bfef01 <gcc8_c_support.c.ba290747+0xbf854b>,52(sp)
 210:	|  |  |  |            move.b 52(sp),272a <_ZL13sSavedCIAACRB>
	sSavedCIABCRA = ciab.ciacra;
 218:	|  |  |  |            move.b bfde00 <gcc8_c_support.c.ba290747+0xbf744a>,53(sp)
 220:	|  |  |  |            move.b 53(sp),2729 <_ZL13sSavedCIABCRA>
	sSavedCIABCRB = ciab.ciacrb;
 228:	|  |  |  |            move.b bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>,d7
 22e:	|  |  |  |            move.b d7,2728 <_ZL13sSavedCIABCRB>

	// Clear CIA Alarm count.
	ciab.ciacrb = CIACRBF_ALARM;
 234:	|  |  |  |            move.b #-128,bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>
	ciab.ciatodhi = 0;
 23c:	|  |  |  |            move.b #0,bfda00 <gcc8_c_support.c.ba290747+0xbf704a>
	ciab.ciatodmid = 0;
 244:	|  |  |  |            move.b #0,bfd900 <gcc8_c_support.c.ba290747+0xbf6f4a>
	ciab.ciatodlow = 0;
 24c:	|  |  |  |            move.b #0,bfd800 <gcc8_c_support.c.ba290747+0xbf6e4a>

	// Clear all CIA controls.
	ciaa.ciacra = 0;
 254:	|  |  |  |            move.b #0,bfee01 <gcc8_c_support.c.ba290747+0xbf844b>
	ciaa.ciacrb = 0;
 25c:	|  |  |  |            move.b #0,bfef01 <gcc8_c_support.c.ba290747+0xbf854b>
	ciab.ciacra = 0;
 264:	|  |  |  |            move.b #0,bfde00 <gcc8_c_support.c.ba290747+0xbf744a>
	ciab.ciacrb = 0;
 26c:	|  |  |  |            move.b #0,bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>

	// Clear CIA TOD count.
	ciab.ciatodhi = 0;
 274:	|  |  |  |            move.b #0,bfda00 <gcc8_c_support.c.ba290747+0xbf704a>
	ciab.ciatodmid = 0;
 27c:	|  |  |  |            move.b #0,bfd900 <gcc8_c_support.c.ba290747+0xbf6f4a>
	ciab.ciatodlow = 0;
 284:	|  |  |  |            move.b #0,bfd800 <gcc8_c_support.c.ba290747+0xbf6e4a>

	// Pause CIA TOD count.
	ciab.ciatodhi = 0;
 28c:	|  |  |  |            move.b #0,bfda00 <gcc8_c_support.c.ba290747+0xbf704a>
...
void System_WaitVbl(u32 vend, u32 mask)
{
 ...
 2b4:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 2ba:	|  |  |  |        |   andi.l #130816,d0
 2c0:	|  |  |  |        \-- beq.s 2b4 <main+0x240>
	while ((custom.vpos32 & mask) != vend) {}
 2c2:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 2c8:	|  |  |  |        |   andi.l #130816,d0
 2ce:	|  |  |  |        \-- bne.s 2c2 <main+0x24e>
	while ((custom.vpos32 & mask) == vend) {}
 2d0:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 2d6:	|  |  |  |        |   andi.l #130816,d0
 2dc:	|  |  |  |        \-- beq.s 2d0 <main+0x25c>
	while ((custom.vpos32 & mask) != vend) {}
 2de:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 2e4:	|  |  |  |        |   andi.l #130816,d0
 2ea:	|  |  |  |        \-- bne.s 2de <main+0x26a>
	custom.vposw = 0x8000;
 2ec:	|  |  |  |            move.w #-32768,dff02a <gcc8_c_support.c.ba290747+0xdf8674>
 ...
 320:	|  |  |  |            move.l a4,2736 <_ZL17sSavedIrq6Handler>
	while ((custom.vpos32 & mask) == vend) {}
 326:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 32c:	|  |  |  |        |   andi.l #130816,d0
 332:	|  |  |  |        \-- beq.s 326 <main+0x2b2>
	while ((custom.vpos32 & mask) != vend) {}
 334:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 ...
 352:	|  |  |  |            move.b #8,bfde00 <gcc8_c_support.c.ba290747+0xbf744a>
	ciab.ciaicr = CIAICRF_SETCLR | CIAICRF_TA;
 35a:	|  |  |  |            move.b #-127,bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>
	ciab.ciatalo = kATimerCount & 255;
 362:	|  |  |  |            move.b #-72,bfd400 <gcc8_c_support.c.ba290747+0xbf6a4a>
	ciab.ciacrb = CIACRAF_RUNMODE;
 36a:	|  |  |  |            move.b #8,bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>
	ciab.ciaicr = CIAICRF_SETCLR | CIAICRF_TB;
 372:	|  |  |  |            move.b #-126,bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>
	ciab.ciatblo = kBTimerCount & 255;
 37a:	|  |  |  |            move.b #-84,bfd600 <gcc8_c_support.c.ba290747+0xbf6c4a>
	ciab.ciaicr = CIAICRF_SETCLR | CIAICRF_ALRM;
 382:	|  |  |  |            move.b #-124,bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>
	ciab.ciacrb |= CIACRBF_ALARM;
 38a:	|  |  |  |            move.b bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>,d0
 390:	|  |  |  |            ori.b #-128,d0
 394:	|  |  |  |            move.b d0,bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>
	ciab.ciatodhi  = kAlarmCount >> 16;
 39a:	|  |  |  |            move.b #0,bfda00 <gcc8_c_support.c.ba290747+0xbf704a>
	ciab.ciatodmid = kAlarmCount >> 8;
 3a2:	|  |  |  |            move.b #0,bfd900 <gcc8_c_support.c.ba290747+0xbf6f4a>
	ciab.ciatodlow = kAlarmCount;
 3aa:	|  |  |  |            move.b #90,bfd800 <gcc8_c_support.c.ba290747+0xbf6e4a>
	ciab.ciacrb &= ~CIACRBF_ALARM;
 3b2:	|  |  |  |            move.b bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>,d0
 3b8:	|  |  |  |            andi.b #127,d0
 3bc:	|  |  |  |            move.b d0,bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>
	System_WaitVbl();
 3c2:	|  |  |  |            jsr (a2)
	custom.intena = INTF_SETCLR | INTF_INTEN | INTF_EXTER;
 3c4:	|  |  |  |            move.w #-8192,dff09a <gcc8_c_support.c.ba290747+0xdf86e4>
...
bool System_TestLMB()
{
 ...
 3cc:	|  |  |  |            move.b bfe001 <gcc8_c_support.c.ba290747+0xbf764b>,d0
	if (System_Init())
	{
		if (Init())
		{
 ...
 3d6:	|  |  |  |  /-------- beq.s 428 <main+0x3b4>
	while ((custom.vpos32 & mask) == vend) {}
 3d8:	|  |  |  |  |  /----> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 3de:	|  |  |  |  |  |      andi.l #130816,d0
 3e4:	|  |  |  |  |  +----- beq.s 3d8 <main+0x364>
	while ((custom.vpos32 & mask) != vend) {}
 3e6:	|  |  |  |  |  |  /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 3ec:	|  |  |  |  |  |  |   andi.l #130816,d0
 3f2:	|  |  |  |  |  |  \-- bne.s 3e6 <main+0x372>
	ciab.ciatahi = kATimerCount >> 8;
 3f4:	|  |  |  |  |  |      move.b #11,bfd500 <gcc8_c_support.c.ba290747+0xbf6b4a>
	ciab.ciatbhi = kBTimerCount >> 8;
 3fc:	|  |  |  |  |  |      move.b #13,bfd700 <gcc8_c_support.c.ba290747+0xbf6d4a>
	ciab.ciatodhi  = 0;
 404:	|  |  |  |  |  |      move.b #0,bfda00 <gcc8_c_support.c.ba290747+0xbf704a>
	ciab.ciatodmid = 0;
 40c:	|  |  |  |  |  |      move.b #0,bfd900 <gcc8_c_support.c.ba290747+0xbf6f4a>
	ciab.ciatodlow = 0;
 414:	|  |  |  |  |  |      move.b #0,bfd800 <gcc8_c_support.c.ba290747+0xbf6e4a>
	return !(ciaa.ciapra & CIAF_GAMEPORT0);
 41c:	|  |  |  |  |  |      move.b bfe001 <gcc8_c_support.c.ba290747+0xbf764b>,d0
			while (!System_TestLMB())
 422:	|  |  |  |  |  |      btst #6,d0
 426:	|  |  |  |  |  \----- bne.s 3d8 <main+0x364>
	custom.intena = INTF_EXTER;
 428:	|  |  |  |  \-------> move.w #8192,dff09a <gcc8_c_support.c.ba290747+0xdf86e4>
	System_WaitVbl();
 430:	|  |  |  |            jsr (a2)
	*((System_IrqFunc**) (((u8*) sVBR) + 0x78)) = func;
 432:	|  |  |  |            clr.l 120(a3)
	while ((custom.vpos32 & mask) == vend) {}
 436:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 43c:	|  |  |  |        |   andi.l #130816,d0
 442:	|  |  |  |        \-- beq.s 436 <main+0x3c2>
	while ((custom.vpos32 & mask) != vend) {}
 444:	|  |  |  |        /-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 44a:	|  |  |  |        |   andi.l #130816,d0
 450:	|  |  |  |        \-- bne.s 444 <main+0x3d0>
	u16 test = custom.dmaconr; // For compatiblity with A1000.
 452:	|  |  |  |            move.w dff002 <gcc8_c_support.c.ba290747+0xdf864c>,d0
	while (custom.dmaconr & DMAF_BLTDONE) {}
 458:	|  |  |  |        /-> move.w dff002 <gcc8_c_support.c.ba290747+0xdf864c>,d0
 45e:	|  |  |  |        |   btst #14,d0
 462:	|  |  |  |        \-- bne.s 458 <main+0x3e4>
	ciaa.ciaicr = (u8) ~CIAICRF_SETCLR;
 464:	|  |  |  |            move.b #127,bfed01 <gcc8_c_support.c.ba290747+0xbf834b>
	ciab.ciaicr = (u8) ~CIAICRF_SETCLR;
 46c:	|  |  |  |            move.b #127,bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>
	pending = ciaa.ciaicr;
 474:	|  |  |  |            move.b bfed01 <gcc8_c_support.c.ba290747+0xbf834b>,d0
	pending = ciab.ciaicr;
 47a:	|  |  |  |            move.b bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>,d0
	custom.intena = (u16) ~INTF_SETCLR;
 480:	|  |  |  |            move.w #32767,dff09a <gcc8_c_support.c.ba290747+0xdf86e4>
	custom.intreq = (u16) ~INTF_SETCLR;
 488:	|  |  |  |            move.w #32767,dff09c <gcc8_c_support.c.ba290747+0xdf86e6>
	custom.dmacon = (u16) ~DMAF_SETCLR;
 490:	|  |  |  |            move.w #32767,dff096 <gcc8_c_support.c.ba290747+0xdf86e0>
 ...
 4b0:	|  |  |  |            move.l 38(a0),dff080 <gcc8_c_support.c.ba290747+0xdf86ca>
	custom.cop2lc = (u32) GfxBase->LOFlist;
 4b8:	|  |  |  |            move.l 50(a0),d0
 4bc:	|  |  |  |            move.l d0,dff084 <gcc8_c_support.c.ba290747+0xdf86ce>
	custom.copjmp1 = 0;
 4c2:	|  |  |  |            move.w #0,dff088 <gcc8_c_support.c.ba290747+0xdf86d2>
	custom.adkcon = ADKF_SETCLR | sSavedADKCON;
 4ca:	|  |  |  |            ori.w #-32768,d4
 4ce:	|  |  |  |            move.w d4,dff09e <gcc8_c_support.c.ba290747+0xdf86e8>
	custom.dmacon = DMAF_SETCLR | sSavedDMACON;
 4d4:	|  |  |  |            ori.w #-32768,d3
 4d8:	|  |  |  |            move.w d3,dff096 <gcc8_c_support.c.ba290747+0xdf86e0>
	custom.intena = INTF_SETCLR | sSavedINTENA;
 4de:	|  |  |  |            ori.w #-32768,d2
 4e2:	|  |  |  |            move.w d2,dff09a <gcc8_c_support.c.ba290747+0xdf86e4>
	ciaa.ciacra = sSavedCIAACRA;
 4e8:	|  |  |  |            move.b 51(sp),bfee01 <gcc8_c_support.c.ba290747+0xbf844b>
	ciaa.ciacrb = sSavedCIAACRB;
 4f0:	|  |  |  |            move.b 52(sp),bfef01 <gcc8_c_support.c.ba290747+0xbf854b>
	ciab.ciacra = sSavedCIABCRA;
 4f8:	|  |  |  |            move.b 53(sp),bfde00 <gcc8_c_support.c.ba290747+0xbf744a>
	ciab.ciacrb = sSavedCIABCRB;
 500:	|  |  |  |            move.b d7,bfdf00 <gcc8_c_support.c.ba290747+0xbf754a>
	ciaa.ciaicr = sSavedCIAAICR;
 506:	|  |  |  |            move.b d6,bfed01 <gcc8_c_support.c.ba290747+0xbf834b>
	ciab.ciaicr = sSavedCIABICR;
 50c:	|  |  |  |            move.b d5,bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>
	ciaa.ciaicr = CIAICRF_SETCLR | CIAICRF_SP;
 512:	|  |  |  |            move.b #-120,bfed01 <gcc8_c_support.c.ba290747+0xbf834b>
	Enable();
...
000005fe <_ZL11Irq6Handlerv>:
{
 ...
 600:	       move.b bfdd00 <gcc8_c_support.c.ba290747+0xbf734a>,d0
	custom.intreq = INTF_EXTER;
 606:	       move.w #8192,dff09c <gcc8_c_support.c.ba290747+0xdf86e6>
	if (pending & CIAICRF_TA)
 60e:	       btst #0,d0
 612:	   /-- beq.s 624 <_ZL11Irq6Handlerv+0x26>
		custom.color[0] = 0x0f0;
 614:	   |   move.w #240,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
		custom.color[0] = 0x000;
 61c:	   |   move.w #0,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
	if (pending & CIAICRF_TB)
 624:	   \-> btst #1,d0
 628:	   /-- beq.s 63a <_ZL11Irq6Handlerv+0x3c>
		custom.color[0] = 0x00f;
 62a:	   |   move.w #15,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
		custom.color[0] = 0x000;
 632:	   |   move.w #0,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
 ...
 648:	|  |   move.w #4080,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
			custom.color[0] = 0x000;
 650:	|  |   move.w #0,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
			ciab.ciatodhi  = (kAlarmCount - 1) >> 16;
 658:	|  |   move.b #0,bfda00 <gcc8_c_support.c.ba290747+0xbf704a>
			ciab.ciatodmid = (kAlarmCount - 1) >> 8;
 660:	|  |   move.b #0,bfd900 <gcc8_c_support.c.ba290747+0xbf6f4a>
			ciab.ciatodlow = (kAlarmCount - 1);
 668:	|  |   move.b #89,bfd800 <gcc8_c_support.c.ba290747+0xbf6e4a>
			sToggle = true;
 ...
 680:	   \-> move.w #3840,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
			custom.color[0] = 0x000;
 688:	       move.w #0,dff180 <gcc8_c_support.c.ba290747+0xdf87ca>
			sToggle = false;
...
0000069a <_Z14System_WaitVbljj.constprop.0>:
	while ((custom.vpos32 & mask) == vend) {}
 69a:	/-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
 6a0:	|   andi.l #130816,d0
 6a6:	\-- beq.s 69a <_Z14System_WaitVbljj.constprop.0>
	while ((custom.vpos32 & mask) != vend) {}
 6a8:	/-> move.l dff004 <gcc8_c_support.c.ba290747+0xdf864e>,d0
